...
const navigationGroups: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Routes, visit schedules, customer visits, sales targets, and commission',
        href: '/admin/sales-force',
        icon: Route,
        permission: 'orders:view',
      },
      {
      ...
      {
        label: 'Wholesale',
        description: 'Bulk order customers, wholesale pricing, and order history',
      ...
      {
        label: 'Task Board',
        description: 'Assign and track work across inventory, sales, support, and warehouse',
        href: '/admin/tasks',
        icon: ListTodo,
        permission: 'dashboard:view',
      },
