...
export const MODULE_DEFINITIONS: Array<{
  ...
  { module: 'purchases', label: 'Purchases', actions: ['view', 'create', 'edit', 'delete', 'export'] },
  ...
  return {
    ...
    roles: {
      ...
      purchase_manager: {
        ...
        description: 'Manages vendors, purchase entries and dues, product cost, stock levels, and reorder planning.',
        permissions: toPermissionSet([
          'dashboard:view',
          'products:view', 'products:create', 'products:edit', 'products:export',
