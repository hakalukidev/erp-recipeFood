  ...
  return {
    ...
    roles: {
      ...
      manager: {
        ...
        description: 'Runs day-to-day inventory, sales, and dealer operations.',
        permissions: toPermissionSet([
          'dashboard:view',
      ...
      sales_manager: {
        id: 'sales_manager',
        name: 'Sales Manager',
        description: 'Owns the sales pipeline: orders, dealers, and sales reporting for the whole team.',
        permissions: toPermissionSet([
          'dashboard:view',
          'products:view',
      ...
      sales_officer: {
        id: 'sales_officer',
        name: 'Sales Officer',
        description: 'Creates orders and manages dealer relationships.',
        permissions: toPermissionSet([
          'dashboard:view',
          'products:view',
          'orders:view', 'orders:create', 'orders:edit', 'orders:export',
      ...
      purchase_manager: {
        ...
        description: 'Manages product cost, stock levels, and reorder planning.',
        permissions: toPermissionSet([
          'dashboard:view',
          'products:view', 'products:create', 'products:edit', 'products:export',
          'orders:view',
      ...
      qc_officer: {
        id: 'qc_officer',
        name: 'QC Officer',
        description: 'Records quality-check results on production batches.',
        permissions: toPermissionSet([
          'dashboard:view',
    ...
    orders: {
      ...
      ord_1003: {
        id: 'ord_1003',
        billNumber: 'INV-1003',
        dealerId: 'dealer_three',
        dealerName: 'Shanta Enterprise',
